...
CUSTOM_HAL_IMGSENSOR = s5k3l8xx_mipi_raw s5k3l8_mipi_raw ov5695_mipi_raw ov5695_ofilm_mipi_raw
CUSTOM_HAL_LENS = dw9800af dw9801af dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS = 
CUSTOM_HAL_MAIN_IMGSENSOR = s5k3l8xx_mipi_raw s5k3l8_mipi_raw
CUSTOM_HAL_MAIN_LENS = dw9800af dw9801af
CUSTOM_HAL_MSENSORLIB = mmc3524x mmc328x akm8975 ami304 yamaha530 mag3110 akmd8963 bmm050 mc6420 mmc3416x s62xd lsm303md qmc5983 akmd09911 mc64xx bmm056 mc41xx
...
CUSTOM_KERNEL_IMGSENSOR = s5k3l8xx_mipi_raw s5k3l8_mipi_raw ov5695_mipi_raw ov5695_ofilm_mipi_raw
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = dw9800af dw9801af dummy_lens
CUSTOM_KERNEL_MAGNETOMETER = yes
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN2_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_LENS = 
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5k3l8xx_mipi_raw s5k3l8_mipi_raw
CUSTOM_KERNEL_MAIN_LENS = dw9800af dw9801af
...
MTK_BUILD_VERNO = X601-H537A-N-170520V103
MTK_BWC_SUPPORT = yes
MTK_C2K_LTE_MODE = 0
...
#OS,Modify by chenyang start
#MTK_PRIVACY_PROTECTION_LOCK = yes
#OS,Modify by chenyang end
...
#M: [PPD] mingyuan.wang  2017.01.16 close DuralSpeed start
MTK_RUNNING_BOOSTER_SUPPORT = no
#M: [PPD] mingyuan.wang  2017.01.16 close DuralSpeed end
...
# modify close usb-uart by peixuan.qiu 20170112 start
MTK_UART_USB_SWITCH = no
# modify close usb-uart by peixuan.qiu 20170112 end
MTK_UIPQ_SUPPORT = no
...
#CREATE_PROJECT_INFO=2016100321317
...
RLK_DEVICE_NAME = Infinix-X601-LTE
#add chenlijia end
...
# OS: add none by liangsiqi 20161115 start
OS_FINGERPRINT_SUPPORT = yes
# OS: add none by liangsiqi 20161115 end
...
RLK_CAMERA_SUPERPHOTO = yes
#yizhaoyang for vendor software architecture version2.0 start
RLK_VENDOR_SOFTWARE_ARCHITECTURE_V2 = yes
#yizhaoyang for vendor software version2.0 end 
RLK_MIDTEST_SUPPORT=yes 
#add UserGuide-liuhaojie start
RLK_USERGUIDE_VERSION = x601_537_a1_n
#add UserGuide-liuhaojie end

# OS: add XOSN-6344 by wangweikang 20170410 start
OS_VERSION = v2.2
RLK_XOS_PATCH_ID = XOS-P57-170515
# OS: add XOSN-6344 by wangweikang 20170410 end

#XOS Camera2.5 liyang add
RLK_CAMERA_TORCH_SUPPORT=yes
#end
#OS: add by lulingjie for hall 20161027 start
RLK_HALL_SUPPORT = yes
RLK_HALL_STYLE = 1
RLK_HALL_WIDTH = 1080
RLK_HALL_HEIGHT = 2064
#OS: add by lulingjie for hall 20161027 end
...
#miaowei add ae metering mode for X601N 20161114 start
RLK_CAMERA_MANUAL_AE_METERING_SUPPORT = yes
#miaowei add ae metering mode for X601N 20161114 end
#miaowei add manual shutter for X601N 20161114 start
RLK_CAMERA_MANUAL_SHUTTER_SUPPORT = yes
#miaowei add manual shutter for X601N 20161114 end
#miaowei add manual af for X601N 20161114 start
RLK_CAMERA_MANUAL_AF = yes
#miaowei add manual af for X601N 20161114 end
#miaowei add front_flashlight level for X601N 20161116 start
RLK_CAMERA_FRONT_FLASHLIGHT_LEVEL_SUPPORT = yes
#miaowei add front_flashlight level for X601N 20161116 end
#XOS Camera BURST Mode
ARCSOFT_BURST_SUPPORT = yes
#XOS Camera BURST Mode
#add by likai for ledLight start
RLK_LED_LIGHT_SUPPORT = yes
RLK_LED_SWITCH_SUPPORT = yes
#add by likai for ledLight end
#miaowei add for front camera video support 720P
RLK_VIDEO_QUALITY_720P_SUPPORT = yes 
#add chenlijia start
RLK_INPUT_METHOD_DEFAULT = yes
#add chenlijia end
#ADD [PPD]   mingyuan.wang 2016.12.26 PPS
MTK_PPS_SUPPORT = yes
#end
#ADD [PPD] qiong.wang 2017.02.05 remove wakelock
RLK_REMOVE_WAKELOCK_SUPPORT = yes
#end
RLK_CAMERA_WATERMASK = yes
